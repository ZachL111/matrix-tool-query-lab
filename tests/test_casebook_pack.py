"""Regression checks for the matrix-tool-query-lab casebook."""
...
from casebook.harness import assert_expected, matrix_tool_query_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(matrix_tool_query_lab_summary(), assert_expected())
